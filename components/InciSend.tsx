      ...
      <div className="w-full max-w-md">
        ...
        {mode === "send" && (
          <div className="rounded-2xl bg-white p-6 shadow-xl space-y-5">
            ...
            <div
              className="cursor-pointer rounded-xl border-2 border-dashed border-slate-300 p-6 text-center hover:border-indigo-400 hover:bg-indigo-50"
              onClick={() => document.getElementById("fileInput")?.click()}
            >
              <UploadCloud className="mx-auto h-8 w-8 text-indigo-600" />
              <p className="mt-2 text-sm font-medium">Drag & drop your file</p>
            ...
            {code && (
              <div className="rounded-xl bg-indigo-600 p-5 text-center text-white">
                <p className="text-xs uppercase opacity-80">Your Magic Code</p>
